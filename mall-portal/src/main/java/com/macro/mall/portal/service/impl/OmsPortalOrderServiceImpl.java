...
public class OmsPortalOrderServiceImpl implements OmsPortalOrderService {
    ...
    @Override
    public CommonResult generateCustomOrder(OrderParam orderParam) {
        List<OmsOrderItem> orderItemList = new ArrayList<>();
        //获取购物车及优惠信息
        UmsMember currentMember = memberService.getCurrentMember();
        List<CartPromotionItem> cartPromotionItemList = cartItemService.listCustomPromotion(currentMember.getId(), orderParam);
        for (CartPromotionItem cartPromotionItem : cartPromotionItemList) {
            //生成下单商品信息
            OmsOrderItem orderItem = new OmsOrderItem();
            orderItem.setProductId(cartPromotionItem.getProductId());
    ...
    public OmsOrderDetail detail(Long id) {
        return portalOrderDao.getDetail(id);
    }
