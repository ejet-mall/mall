...
import com.macro.mall.dao.CmsSubjectDao;
...
public class CmsSubjectServiceImpl implements CmsSubjectService {
    ...
    @Override
    public List<CmsSubjectProductResult> getProductList(Long subjectId, Integer pageNum, Integer pageSize) {
        PageHelper.startPage(pageNum, pageSize);
        return cmsSubjectDao.getProductList(subjectId);
    }
}
